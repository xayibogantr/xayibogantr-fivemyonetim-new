...
const log = {
    ...
    /** Special case log handler for specifc logs
     *  Or just outright void spammy logging (heartbeats)
     * @param {string|object} err - error to process */
    handler: (type, err) => {
        const e = err.toString();
        if (e.includes("[DISALLOWED_INTENTS]")) log.error("YOU DIDN'T ENABLE INTENTS \"setup\"");
    ...
    /** Special case error handler for  specifc errors
